<?php include ('header.php') ?>
    ...
    <img src="photos/guestmoorageheadimg.png" class="img-responsive" id = "homeImg" alt="Responsive image">
      </div>
   <div class="container" id="guestmooragecont">
      <div class="row">
        ...
        <div class="col-xs-12">
          ...
          <div class="row">
            ...
            <div class="col-xs-6 col-lg-4">
              <h2>Amenities</h2>
              <p>We have rest-rooms, shower and laundry facilities. We provide boats and yachts for sale through our marina brokerage.</p>
            </div><!--/.col-xs-6.col-lg-4-->
          </div><!--/row-->
